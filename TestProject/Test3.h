...
namespace TestProject {
	...
	/// Сводка для Test3
	/// </summary>
	public ref class Test3 : public System::Windows::Forms::Form
	{
	public:
		Test3(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(485, 206);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(1109, 49);
			this->label1->TabIndex = 2;
			this->label1->Text = L" Какие элементы входят в состав системы управления\?";
			...
			this->groupBox1->Font = (gcnew System::Drawing::Font(L"Times New Roman", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->groupBox1->Location = System::Drawing::Point(458, 275);
			...
			this->D->Name = L"D";
			this->D->Size = System::Drawing::Size(271, 36);
			this->D->TabIndex = 14;
			this->D->Text = L"D) Модель данных";
			this->D->UseVisualStyleBackColor = true;
			this->D->CheckedChanged += gcnew System::EventHandler(this, &Test3::radioButton1_CheckedChanged);
			// 
			// C
			// 
			...
			this->C->Name = L"C";
			this->C->Size = System::Drawing::Size(526, 36);
			this->C->TabIndex = 13;
			this->C->Text = L"C) Устройство обработки информации";
			this->C->UseVisualStyleBackColor = true;
			this->C->CheckedChanged += gcnew System::EventHandler(this, &Test3::radioButton1_CheckedChanged);
			// 
			// B
			// 
			...
			this->B->Name = L"B";
			this->B->Size = System::Drawing::Size(265, 36);
			this->B->TabIndex = 12;
			this->B->Text = L"B) Внешняя среда";
			this->B->UseVisualStyleBackColor = true;
			this->B->CheckedChanged += gcnew System::EventHandler(this, &Test3::radioButton1_CheckedChanged);
			// 
			// A
			// 
			...
			this->A->Name = L"A";
			this->A->Size = System::Drawing::Size(322, 36);
			this->A->TabIndex = 11;
			this->A->Text = L"A) Объект управления";
			this->A->UseVisualStyleBackColor = true;
			this->A->CheckedChanged += gcnew System::EventHandler(this, &Test3::radioButton1_CheckedChanged);
			// 
			// label2
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Times New Roman", 10.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(832, 629);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(207, 50);
			this->button1->TabIndex = 10;
			this->button1->Text = L"Проверить ответ";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Test3::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Times New Roman", 10.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(1054, 629);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(207, 50);
			this->button2->TabIndex = 11;
			this->button2->Text = L"Следующий вопрос";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &Test3::button2_Click);
			// 
			// progressBar1
			// 
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &Test3::timer1_Tick);
			// 
			// label3
			// 
			...
			this->Load += gcnew System::EventHandler(this, &Test3::Test3_Load);
...
#pragma endregion
	...
	private: System::Void Test3_Load(System::Object^ sender, System::EventArgs^ e)
	{
		timer1->Start();
	}
