...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Text = L"Впишите подходящее пропущеное слово:";
			// 
			// label2
			// 
			...
			this->label2->Text = L"неизвестного выходного результата при известных входных\r\nданных.";
			...
			this->label1->Text = L"задача моделирования связана с определением\r\n";
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) 
{
	...
	if (textBox1->Text == "")
		MessageBox::Show("Впишите вариант ответа!", "Результат", MessageBoxButtons::OK, MessageBoxIcon::Error);
	else if (textBox1->Text->ToLower()->Trim() == "прямая")
	{
